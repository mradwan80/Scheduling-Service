...
public class ScheduleController {
    ...
    public Optional<User> getUserV1(@PathVariable("id") UUID id)
    {
    ...
    public String createUserV1(@RequestBody User user)
    ...
    public String updateUserV1(@PathVariable("id") UUID id, @RequestBody User user)
    {
    ...
    public String deleteUserV1(@PathVariable("id") UUID id)
    {
